      ...
      <footer className="tw-bg-white tw-rounded-md">
        <div className="tw-mx-auto tw-w-full tw-max-w-screen-xl tw-p-4 tw-py-6 lg:tw-py-8">
          <div className="md:tw-flex md:tw-justify-between">
            <div className="tw-mb-6 md:tw-mb-0">
              ...
              >
                <Image
                  ...
                  width={41}
                  height={32}
                  className="tw-h-8 tw-mr-3 tw-self-center"
                  alt="FlowBite Logo"
                />
                <span className="tw-self-center tw-text-lg tw-font-semibold tw-whitespace-nowrap ">
            ...
            <div className="tw-grid tw-grid-cols-2 tw-gap-8 sm:tw-gap-6 sm:tw-grid-cols-3">
              <div>
                ...
                <ul className="tw-text-gray-600  tw-font-medium">
          ...
          <div className="sm:tw-flex sm:tw-items-center sm:tw-justify-between">
            ...
            <div className="tw-flex tw-mt-4 tw-space-x-6 sm:tw-justify-center sm:tw-mt-0">
              <a href="#" className="tw-text-gray-500 hover:tw-text-gray-900 ">
                <svg
